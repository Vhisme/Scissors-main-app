...
interface IFeaturesPgProps {
}

const FeaturesPg: React.FunctionComponent<IFeaturesPgProps> = () => {
  return(
    <>
     <div className="features-section" id="feature">
        <div className="flex gap-32 justify-center p-7  border bg-[#F9FBFD]">
        ...
        <div className="flex p-9 bg-[#1E3448] ">
          <div className="flex justify-center">
            <div className="whychoosescissors w-1/2 text-white ">
            ...
            <div className="flex gap-12 ">
              <div>
                <Link to="/shortenedUrl">
                  <div className="border border-black bg-slate-200 h-8 w-8 rounded-full p-2 flex justify-center">
                    <img src={seamlink} alt="Slink" />
                  </div>
                </Link>
                <div className="text-white">
                  <h1 className="font-bold mt-4 mb-4 text-white">
                    URL Shortening
                  </h1>
                  <p>
